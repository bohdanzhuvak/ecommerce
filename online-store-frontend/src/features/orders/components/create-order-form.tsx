        ...
        <DrawerContent>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{cart?.items.reduce((sum, item) => sum + item.quantity, 0) || 0}</span>
                </div>
                <div className="flex justify-between">
            ...
            <div>
              ...
              {addressesLoading ? (
                ...
                <div className="text-center py-4">
                  <p className="text-gray-500 mb-2">No delivery addresses found</p>
            ...
            <div className="flex space-x-3 pt-4">
              ...
              <Button
                type="submit"
                disabled={createOrderMutation.isPending || !selectedAddressId || !addresses?.length}
                className="flex-1"
              >
