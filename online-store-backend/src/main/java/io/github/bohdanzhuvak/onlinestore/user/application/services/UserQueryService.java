...
import io.github.bohdanzhuvak.onlinestore.user.application.usecases.GetUserProfileByEmailUseCase;
import io.github.bohdanzhuvak.onlinestore.user.application.usecases.GetUserProfileByIdUseCase;
import io.github.bohdanzhuvak.onlinestore.user.application.usecases.ValidateCredentialsUseCase;
...
public class UserQueryService implements UserQuery {
  ...
  public UserQueryService(CreateUserUseCase createUserUseCase, ValidateCredentialsUseCase validateCredentialsUseCase) {
