...
@UseCase
public class CreditBalanceForRefundUseCase {
  private final BalanceRepository balanceRepository;
  private final TransactionRepository transactionRepository;

  public CreditBalanceForRefundUseCase(BalanceRepository balanceRepository, TransactionRepository transactionRepository) {
    this.balanceRepository = balanceRepository;
    this.transactionRepository = transactionRepository;
  }

  public void execute(CreditBalanceForRefundCommand command) {
  ...
  public record CreditBalanceForRefundCommand(
      UserId userId,
      Money amount,
      String description
  ) {
