...
public record DeliveryAddressSnapshot(DeliveryAddressId id, String street, String city, String state, String postalCode,
                                      String country, String recipientName) {
  public DeliveryAddressSnapshot(DeliveryAddressId id, String street, String city, String state,
